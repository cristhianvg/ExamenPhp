...
class editarArticulo extends controllerExtended {
  ...
  public function main(\request $request) {
    try {
      ...
      $articulo->setDescripcion($request->getParam('descripcion'), $this->getConfig()->getHash());
      $articulo->setId($request->getParam('id'));

     $articuloDAO = new articuloDAOExt($this->getConfig());
      $respuesta1 = $articuloDAO->update($articulo);
      $respuesta2 = array(
